...
t3_h = get_times_from_logs(base + "artifacts/phase3_scaling/n30_logs/t3_micro_phase2_run_*.log")
t3_v = get_times_from_logs(base + "artifacts/phase3_scaling/n30_logs/t3_2xlarge_phase2_run_*.log")
