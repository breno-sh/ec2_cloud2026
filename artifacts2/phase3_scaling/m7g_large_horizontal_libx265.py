#!/usr/bin/env python3
"""
Phase 3.2 OPTIMIZED — Horizontal: 10× m7g.large with custom AMI (ARM Graviton3).
Codec: libx265 (H.265/HEVC)

Methodology is IDENTICAL to c5_large_horizontal_opt.py:
  - Fresh EC2 instances launched per run (no reuse)
  - Same video file, same split, same FFmpeg parameters (except codec=libx265)
  - Same sleep(30) after instance_running before SSH
  - Same timing: Total Time = wall clock from split_start to last parallel worker done
  - Same log format: "RESULTS — 10x m7g.large Horizontal OPTIMIZED"
"""
...
EXPECTED_CPU = None   # ARM Graviton3 instances are 100% homogeneous — no mismatch possible
THREADS = 5
CODEC = "libx265"
BITRATE = "2M"
PRESET = "slow"
...
PARTS_DIR = "/home/breno/doutorado/ec2sweetspot_noms2/artifacts2/phase3_scaling/video_parts_m7g_large_libx265"
COMPRESSED_DIR = "/home/breno/doutorado/ec2sweetspot_noms2/artifacts2/phase3_scaling/compressed_m7g_large_libx265"

AWS_CONFIG = {
    "ami_id": "ami-0976d56fa61f42304",   # pre-built ARM AMI (ffmpeg pre-installed)
    ...
    try:
        ...
        try:
            ...
            cmd = (f"ffmpeg -i /home/ubuntu/input.mp4 "
                   ...
                   f"-threads {THREADS} -y /home/ubuntu/output.mp4")
...
if __name__ == "__main__":
    ...
    with open("m7g_large_horizontal_libx265.log", "w") as logfile:
